...
<img src="./image/Screenshot_04.png" alt="Code Editor" width="60%">
...
### ミニマップ機能
これは、コードのミニマップを表示する機能です。\
ミニマップとは、コード全体を縮小して画面右側に表示し、全体を把握したり目的の場所へ移動する際に役立つ機能です。\
モーダル設定のMinimapのトグルで表示・非表示を切り替えることができます。

# プレビュー
エディターには、現在開発中の機能が搭載された、プレビュー版というものが存在します。（2026/4/20作成）\
こちらは、細かい頻度で更新され、開発中の新機能を試すことができます。ただし、バグが発生したりすることがあるので、使用には注意してください。\
プレビュー版と本実装版のバージョンが一致している場合、開発中の新機能がないことを表しています。\
プレビュー版は[こちら](https://cod-git12.github.io/Bloxd-Code-Editor/preview.html)から見ることができます。